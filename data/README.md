...
The inventory currently contains 771 entries:

- 718 `core` entries adapted from the MIT-licensed Open Anki JLPT N5 deck at
  commit `1ad66734417aca9dbcca6b2d5ee440cb13ab3ba0`.
- 53 `supplemental` entries: 38 recognizable and motivating beginner words plus
  15 words needed by the current lessons. These include `ラーメン`, `寿司`,
